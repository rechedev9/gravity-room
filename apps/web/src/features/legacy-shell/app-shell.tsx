...
const ProgramApp = lazy(() =>
  import('@/features/tracker/program-app').then((m) => ({ default: m.ProgramApp }))
);
...
// Legacy shell kept for old tests and migration safety while the route-based app layout
// becomes the primary navigation structure.
