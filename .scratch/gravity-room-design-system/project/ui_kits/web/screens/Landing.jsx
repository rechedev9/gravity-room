    ...
    <>
      ...
      <section className="hero">
        ...
        <p className="hero__subtitle">
          Stop guessing at the gym. Follow proven programs that automatically adjust weight, sets,
          and reps — so every session moves you forward.
        </p>
        <div className="hero__cta">
          <Button size="lg" onClick={() => onNav('signin')}>
            Start Training Today →
          </Button>
          <Button variant="outline" size="lg" onClick={() => onNav('programs')}>
            See Programs
          </Button>
        </div>
      ...
      <section className="section" id="features">
        <div className="section__head">
          ...
          <p className="section__sub">
            Real data — not guesses. Every feature is tuned for one thing: the next kilo.
          </p>
        </div>
        <div className="features-grid">
          <div className="feature">
            ...
            <p className="feature__body">
              The app decides when to add weight and how to handle failure. You just show up and
              train.
            </p>
          </div>
          <div className="feature">
            ...
            <p className="feature__body">
              Tap one cell. Done. The set grid is the input — no menus, no swipes, no clutter.
            </p>
          </div>
          <div className="feature">
            ...
            <p className="feature__body">
              Charts that show what's actually happening on the bar. PRs, volume, and the trend
              lines that matter.
            </p>
          </div>
          <div className="feature">
            ...
            <p className="feature__body">
              Plan from your laptop. Track on your phone. Same session, same data, no friction.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="how">
        ...
        <div className="howit">
          <div className="howit__step">
            ...
            <p>
              Pick from proven, battle-tested templates. GZCLP, 5/3/1, Starting Strength — or roll
              your own.
            </p>
          </div>
          <div className="howit__step">
            ...
            <p>
              Open the app. Follow the prescribed sets. Tap each one done. The system handles the
              rest.
            </p>
          </div>
          <div className="howit__step">
            ...
            <p>
              The bar gets heavier. Every week. Every session. Every kilo is gravity you've
              conquered.
            </p>
          </div>
        </div>
      ...
      <section className="section">
        <div className="cta-block">
          ...
          <p className="section__sub" style={{ marginBottom: 32 }}>
            Enter the Gravity Room. Start training today.
          </p>
          <Button size="lg" onClick={() => onNav('signin')}>
