      ...
      <div className="dash-grid">
        <div className="l-card" style={{ padding: 24 }}>
          ...
          <table className="table">
            ...
            <tbody>
              <tr>
                <td className="num">Mon · 04 May</td>
                <td>GZCLP · A1</td>
                <td>SQ · BP · DL</td>
                <td className="num">3,420 kg</td>
                <td>
                  <Badge tone="ok">✓ Complete</Badge>
                </td>
              </tr>
              <tr>
                <td className="num">Sat · 02 May</td>
                <td>GZCLP · B2</td>
                <td>OHP · DL · BP</td>
                <td className="num">2,890 kg</td>
                <td>
                  <Badge tone="ok">✓ Complete</Badge>
                </td>
              </tr>
              <tr>
                <td className="num">Thu · 30 Apr</td>
                <td>GZCLP · A2</td>
                <td>SQ · OHP · LAT</td>
                <td className="num">3,180 kg</td>
                <td>
                  <Badge tone="fail">3/5 last set</Badge>
                </td>
              </tr>
              <tr>
                <td className="num">Tue · 28 Apr</td>
                <td>GZCLP · B1</td>
                <td>OHP · DL · BP</td>
                <td className="num">2,740 kg</td>
                <td>
                  <Badge tone="ok">✓ Complete</Badge>
                </td>
              </tr>
              <tr>
                <td className="num">Mon · 27 Apr</td>
                <td>GZCLP · A1</td>
                <td>SQ · BP · DL</td>
                <td className="num">3,360 kg</td>
                <td>
                  <Badge tone="ok">✓ Complete</Badge>
                </td>
              </tr>
        ...
        <div className="l-card" style={{ padding: 24 }}>
          ...
          <div style={{ marginTop: 24 }}>
            <Button size="lg" onClick={() => onNav('tracker')} style={{ width: '100%' }}>
              Start Workout →
            </Button>
          </div>
        </div>
